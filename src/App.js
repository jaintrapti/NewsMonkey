    ...
    return ( 
      ...
      <Router>
        ...
        <Switch>
          ...
          <News key="genera"  pageSize={this.pageSize} country="in" category="general" />
           </Route>
          ...
          <Route exact path="/science"> <News key="cience"  pageSize={this.pageSize} country="in" category="science" /> </Route>
